...
| --------------- | ------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- |
| micro-editor    | https://github.com/micro-editor/micro                              | [![GitHub version](https://badge.fury.io/gh/micro-editor%2Fmicro.svg)](https://badge.fury.io/gh/micro-editor%2Fmicro)       | [![PyPI version](https://badge.fury.io/py/micro-editor.svg)](https://badge.fury.io/py/micro-editor)       |
...
| zig-bin         | https://ziglang.org<br/>https://github.com/ziglang/zig             | [![Winget version](https://img.shields.io/winget/v/zig.zig?label=release)](https://codeberg.org/ziglang/zig)                | [![PyPI version](https://badge.fury.io/py/zig-bin.svg)](https://badge.fury.io/py/zig-bin)                 |
...
| ripgrep-bin     | https://github.com/BurntSushi/ripgrep                              | [![GitHub version](https://badge.fury.io/gh/burntsushi%2Fripgrep.svg)](https://badge.fury.io/gh/burntsushi%2Fripgrep)       | [![PyPI version](https://badge.fury.io/py/ripgrep-bin.svg)](https://badge.fury.io/py/ripgrep-bin)         |
